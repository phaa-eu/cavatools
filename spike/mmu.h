...
class mmu_t {
  long load_model( long a, long pc) { return a; }
  long store_model(long a, long pc) { return a; }
  void amo_model(  long a, long pc) { }
  
 public:
  mmu_t() { }
  void insn_model(long pc) { }
  long jump_model(long npc, long pc) { return npc; }
  ...
  float128_t load_fp128(long a, long pc) { return { load_uint64(a, pc), load_uint64(a+8, pc) }; }
