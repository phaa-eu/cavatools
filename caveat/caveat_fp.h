...
#ifndef NO_FP_MACROS
#define FMADD32( rm, rd, rs1, rs2, rs3) SRM(rm); FR(rd).f =  (FR(rs1).f * FR(rs2).f) + FR(rs3).f; box(rd); SET_FPX; RRM(rm);
#define FMADD32_dyn(rd, rs1, rs2, rs3) FR(rd).f =  (FR(rs1).f * FR(rs2).f) + FR(rs3).f; box(rd); SET_FPX;
#define FMSUB32( rm, rd, rs1, rs2, rs3) SRM(rm); FR(rd).f =  (FR(rs1).f * FR(rs2).f) - FR(rs3).f; box(rd); SET_FPX; RRM(rm);
#define FMSUB32_dyn(rd, rs1, rs2, rs3) FR(rd).f =  (FR(rs1).f * FR(rs2).f) - FR(rs3).f; box(rd); SET_FPX;
#define FNMADD32(rm, rd, rs1, rs2, rs3) SRM(rm); FR(rd).f = -(FR(rs1).f * FR(rs2).f) - FR(rs3).f; box(rd); SET_FPX; RRM(rm);
#define FNMADD32_dyn(rd, rs1, rs2, rs3) FR(rd).f = -(FR(rs1).f * FR(rs2).f) - FR(rs3).f; box(rd); SET_FPX;
#define FNMSUB32(rm, rd, rs1, rs2, rs3) SRM(rm); FR(rd).f = -(FR(rs1).f * FR(rs2).f) + FR(rs3).f; box(rd); SET_FPX; RRM(rm);
#define FNMSUB32_dyn(rd, rs1, rs2, rs3) FR(rd).f = -(FR(rs1).f * FR(rs2).f) + FR(rs3).f; box(rd); SET_FPX;
...
#define FADD32(rm, rd, rs1, rs2) SRM(rm); FR(rd).f = FR(rs1).f + FR(rs2).f; box(rd); SET_FPX; RRM(rm);
#define FADD32_dyn(rd, rs1, rs2) FR(rd).f = FR(rs1).f + FR(rs2).f; box(rd); SET_FPX;
#define FSUB32(rm, rd, rs1, rs2) SRM(rm); FR(rd).f = FR(rs1).f - FR(rs2).f; box(rd); SET_FPX; RRM(rm);
#define FSUB32_dyn(rd, rs1, rs2) FR(rd).f = FR(rs1).f - FR(rs2).f; box(rd); SET_FPX;
#define FMUL32(rm, rd, rs1, rs2) SRM(rm); FR(rd).f = FR(rs1).f * FR(rs2).f; box(rd); SET_FPX; RRM(rm);
#define FMUL32_dyn(rd, rs1, rs2) FR(rd).f = FR(rs1).f * FR(rs2).f; box(rd); SET_FPX;
#define FDIV32(rm, rd, rs1, rs2) SRM(rm); FR(rd).f = FR(rs1).f / FR(rs2).f; box(rd); SET_FPX; RRM(rm);
#define FDIV32_dyn(rd, rs1, rs2) FR(rd).f = FR(rs1).f / FR(rs2).f; box(rd); SET_FPX;
...
#define FSQRT32(rm, rd, rs1) SRM(rm); FR(rd).f = sqrtf(FR(rs1).f); box(rd); SET_FPX; RRM(rm);
#define FSQRT32_dyn(rd, rs1) FR(rd).f = sqrtf(FR(rs1).f); box(rd); SET_FPX;
...
#define FCVTSW( rm, rd, rs1) SRM(rm); FR(rd).f = (float)IR(rs1).i;  box(rd); SET_FPX; RRM(rm);
#define FCVTSW_dyn(rd, rs1) FR(rd).f = (float)IR(rs1).i;  box(rd); SET_FPX;
#define FCVTSWU(rm, rd, rs1) SRM(rm); FR(rd).f = (float)IR(rs1).ui; box(rd); SET_FPX; RRM(rm);
#define FCVTSWU_dyn(rd, rs1) FR(rd).f = (float)IR(rs1).ui; box(rd); SET_FPX;
#define FCVTSL( rm, rd, rs1) SRM(rm); FR(rd).f = (float)IR(rs1).l;  box(rd); SET_FPX; RRM(rm);
#define FCVTSL_dyn(rd, rs1) FR(rd).f = (float)IR(rs1).l;  box(rd); SET_FPX;
#define FCVTSLU(rm, rd, rs1) SRM(rm); FR(rd).f = (float)IR(rs1).ul; box(rd); SET_FPX; RRM(rm);
#define FCVTSLU_dyn(rd, rs1) FR(rd).f = (float)IR(rs1).ul; box(rd); SET_FPX;
...
#define FCVTSD(rm, rd, rs1) SRM(rm); FR(rd).f = (float )FR(rs1).d; box(rd); SET_FPX; RRM(rm);
#define FCVTSD_dyn(rd, rs1) FR(rd).f = (float )FR(rs1).d; box(rd); SET_FPX;
...
#define FMINS(rd, rs1, rs2) FR(rd).f = (FR(rs1).f < FR(rs2).f) ? FR(rs1).f : FR(rs2).f; box(rd); SET_FPX;
#define FMAXS(rd, rs1, rs2) FR(rd).f = (FR(rs1).f > FR(rs2).f) ? FR(rs1).f : FR(rs2).f; box(rd); SET_FPX;
